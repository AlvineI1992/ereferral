    ...
    useEffect(() => {
        ...
        const fetchProfile = async () => {
            try {
                ...
                setAttachments(referralResponse.data.attachments ?? []);
            } catch (error) {
                console.error(error);
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex flex-1 flex-col gap-3 p-3 md:p-4">
                        ...
                        <div className="grid gap-3 xl:grid-cols-[minmax(0,1.08fr)_minmax(0,0.92fr)]">
                            <div className="rounded-2xl border border-white/10 bg-white/8 p-4 backdrop-blur-sm">
                                <div className="flex flex-col gap-3 sm:flex-row sm:items-start">
                                    <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-xl border border-white/15 bg-emerald-200/20 text-lg font-semibold text-white shadow-md shadow-slate-950/15">
                                        {patientInitials}
                                    </div>
                            ...
                            <div className="grid gap-3">
                                <div className="grid gap-3 md:grid-cols-2">
                                    <div className="rounded-2xl border border-white/10 bg-white/8 p-3 backdrop-blur-sm">
                                        ...
                                        <div className="mt-2 space-y-2 text-xs text-teal-50/80">
                                    ...
                                    <div className="rounded-2xl border border-white/10 bg-white/8 p-3 backdrop-blur-sm">
                                        ...
                                        <p className="mt-2 text-xs leading-5 text-teal-50/80">{receivingFocus}</p>
                                    </div>
                                </div>
                ...
                {loading ? (
                    ...
                    <>
                        <section className="grid gap-3 xl:grid-cols-[190px_minmax(0,1fr)]">
                            <Card className="border-slate-200/80 bg-white/90 shadow-sm">
                                    ...
                                    <Card className="border-slate-200/80 bg-white/90 shadow-sm">
                                        <CardContent className="p-4">
                                            ...
                                            {attachments.length > 0 ? (
                                                ...
                                                <div className="mt-3 rounded-xl border border-dashed border-slate-200 bg-slate-50/70 p-5 text-center">
